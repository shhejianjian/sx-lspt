...
//    CGFloat keyHeight = (APPWINDOWHEIGHT(self.view)-Y(searBar)-APPWINDOWHEIGHT(searBar))-keyboardRect.size.height;
...
//    CGFloat curkeyBoardHeight = [[[notify userInfo] objectForKey:@"UIKeyboardBoundsUserInfoKey"] CGRectValue].size.height;
