//
//  LSWSLASecondZxViewController.m
//  LSPT_SX
//
...
@interface LSWSLASecondZxViewController ()<NIDropDownDelegate>
...
@implementation LSWSLASecondZxViewController
extern LSWSLA *mWsla;
- (NSMutableArray *)AYs
{
    if (!_AYs) {
...
- (void)loadData
{
    ...
    [self.zxyjButton setTitle:mWsla.zxyj forState:UIControlStateNormal];
    self.yjjgTextField.text = mWsla.yjjg;
    self.yjwhTextField.text = mWsla.yjwh;
