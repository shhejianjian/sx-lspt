//
//  LSWSLASecondXzViewController.m
//  LSPT_SX
//
...
@interface LSWSLASecondXzViewController ()<NIDropDownDelegate>
...
@implementation LSWSLASecondXzViewController
extern LSWSLA *mWsla;
- (NSMutableArray *)AYs
{
    if (!_AYs) {
...
- (void)loadData
{
    ...
    [self.xzpcButton setTitle:mWsla.tqxzpcfs forState:UIControlStateNormal];
